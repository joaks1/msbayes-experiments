...
(Figure~S\ref{figPowerAccOmegaMedian}) or GLM-adjusted
(Figure~S\ref{figPowerAccOmegaModeGLM}) posterior estimates.
...
(Figures~S\ref{figPowerAccOmegaMedian}E \& S\ref{figPowerAccOmegaModeGLM}E).
...
$3.2\globalpopsize$ generations (Figure~\ref{figPowerOmegaProb}).
...
\section*{The importance of power analysis to guide applications of \msb}
...
\msb seeks to tackle.
To get a sense of the challenge \msb is faced with, we tally up all the free
...
it is not too surprising to find the approach struggles.
