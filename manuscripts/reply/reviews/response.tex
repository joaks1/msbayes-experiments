...
My co-authors and I greatly appreciate the helpful comments of the editor and
reviewers.
In this document, I provide our responses to these comments, including
descriptions of the changes we have made.
...
\response{
    We have reduced the number of words in the main text be 26\%, and
    moved Figures 5 and 6 to the Supporting Information.
}
...
\response{
    ...
    of general interest to readers interested in Bayesian selection of
    evolutionary models.
}
