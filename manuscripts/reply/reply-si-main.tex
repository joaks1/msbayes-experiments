...
and 10 coalescent units suffered from little affect from saturation.
...
prior models.
This prior-predictive approach generating a small number (1000) of random
samples from the prior and plotting the resulting summary statistics in
...
single model (the one-divergence model), and thus its utility for
