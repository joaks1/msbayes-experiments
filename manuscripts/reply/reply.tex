...
values, we can define a prior distribution for all $\theta \subset
...
define a sampling model for all $\theta \subset
\allParameterValues$ and $\alignment{}{} \subset \allDatasets$ such that
...
\begin{equation}
    ...
    \label{eq:bayesrule}
\end{equation}
where $p(\alignment{i}{}) = \int{\myTheta{}} p(\alignment{i}{} \given
...
do not yield a valid posterior distribution from Bayes' rule \citp[e.g.,
