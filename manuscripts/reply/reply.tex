...
{\sffamily
    ...
    priors.
    \citet{Hickerson2013} have responded to this work, criticising the priors
...
are causing the poor behavior of \msb.
...
prior'').
They mention how the use of uniform prior distributions in \msb for many of the
model's parameters necessitates awkward broad priors to avoid excluding the
truth, \textit{a priori}.
...
However, empirical Bayes methods have an uncertain theoretical basis and
...
As we show above, this is a risky strategy, because the resulting plots of this
approach have little correlation with the appropriateness of priors.
...
In fact, when the random draws are tightly clustered around the observed
