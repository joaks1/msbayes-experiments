...
\siSidewaysFigure{../../model-choice/results/power-1/pymsbayes-results/plots/power-accuracy-6.pdf}{
    ...
    simlated datasets in which divergence times are randomly drawn from the
    uniform distributions $\divt{} \sim U(0, \divt{max})$ indicated at the top
    of each column of plots (divergence-time distributions are given in units
    of millions of generations ago (MGA) assuming a per-site rate of 1\e{-8}
...
\siSidewaysFigure{../../model-choice/results/power-1/pymsbayes-results/plots/power-6.pdf}{
    ...
    datasets in which the divergence times are randomly drawn from the uniform
    distributions $\divt{} \sim U(0, \divt{max})$ indicated at the top of each
    column of plots (divergence-time distributions are given in units of
    millions of generations ago (MGA) assuming a per-site rate of 1\e{-8}
    mutations per generation).
}{figPower6}
...
\siSidewaysFigure{../../model-choice/results/power-1/pymsbayes-results/plots/power-exclusion-6.pdf}{
    ...
    datasets in which divergence times are randomly drawn from the uniform
    distributions $\divt{} \sim U(0, \divt{max})$ indicated at the top of each
    column of plots (divergence-time distributions are given in units of
    millions of generations ago (MGA) assuming a per-site rate of 1\e{-8}
    mutations per generation).
