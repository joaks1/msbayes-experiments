...
locus (assuming a per-site mutation rate of $1\e{-8}$ per generation) this
...
It is important that investigators perform power analyses to determine the
...
models with more divergence parameters will be ``averaged'' over much greater
parameter space, all with equal prior weight, and much of it with low
likelihood.
...
These analyses assumed an arbitrary strict per-site mutation rate of $2\e{-8}$
