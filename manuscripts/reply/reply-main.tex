...
this was due to the fact that the marginal likelihoods of models are sensitive
to the use of uniform priors on divergence times.
...
We find the prior sensitivity of the marginal likelihoods is a likely
culprit,
and show that sampling error is not a major contributer to the biases found
by \citet{Oaks2012}.
Fortunately, \citet{Oaks2014dpp} has introduced a new method that uses more
