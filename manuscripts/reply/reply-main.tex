...
\end{itemize}
In the former case, the true (correct) posterior supports models with many
divergence-time parameters given data generated under temporally random
divergences, but the problem arises from our inability to accurately estimate
the posterior.
