    ...
    \begin{tabulary}{\textwidth}{ l L }
        ...
        \midrule
            \empModelOld & $\divTimeIndexVector \sim \priorOld$ \tb
                      $\divTime{} \sim U(0,34.64)$ \tb
                      $\divTime{} \sim U(0,17.3 \; MGA)$ \tb
            ...
            \empModelUniform & $\divTimeIndexVector \sim \priorUniform$ \tb
                      $\divTime{} \sim Exp(0.1)$ \tb
                      $\divTime{} \sim Exp(mean=5 \; MGA)$ \tb
                      $\ancestralTheta{} \sim Exp(200)$ \tb
                      $\descendantTheta{1}{} \sim Exp(200)$ \tb
                      $\descendantTheta{2}{} \sim Exp(200)$ \tb
            ...
            \empModelDPPInform & $\divTimeIndexVector \sim \priorDPP{\sim Gamma(1.5,18.1)}$ \tb
                      $\divTime{} \sim Exp(1/6)$ \tb
                      $\divTime{} \sim Exp(mean=3 \; MGA)$ \tb
                      $\ancestralTheta{} \sim Exp(200)$ \tb
                      $\descendantTheta{1}{} \sim Exp(200)$ \tb
                      $\descendantTheta{2}{} \sim Exp(200)$ \tb
                      $\bottleScalar{1}{} \sim Beta(5, 1)$ \tb
            ...
            \empModelDPPSimple & $\divTimeIndexVector \sim \priorDPP{\sim Gamma(1.5,18.1)}$ \tb
                      $\divTime{} \sim Exp(0.1)$ \tb
                      $\divTime{} \sim Exp(mean=5 \; MGA)$ \tb
                      $\ancestralTheta{} = \descendantTheta{1}{} = \descendantTheta{2}{} \sim Exp(200)$ \tb
                      $\bottleScalar{1}{} = \bottleScalar{2}{} = 1.0$ \\[0.25em]
            \npModelDPP & $\divTimeIndexVector \sim \priorDPP{\sim Gamma(1.5,5.0)}$ \tb
                      $\divTime{} \sim Exp(0.1)$ \tb
                      $\divTime{} \sim Exp(mean=5 \; MGA)$ \tb
                      $\ancestralTheta{} \sim Exp(200)$ \tb
                      $\descendantTheta{1}{} = \descendantTheta{2}{} \sim Exp(200)$ \tb
                      $\bottleScalar{1}{} = \bottleScalar{2}{} = 1.0$ \\[0.25em]
        \bottomrule
    \end{tabulary}
