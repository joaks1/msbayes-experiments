...
fewer divergence events \citep{Oaks2012,Oaks2014reply}.
...
Recently, \citet{Oaks2012} and \citet{Oaks2014reply} found via simulation that
...
\citet{Hickerson2013} suggested the problem is caused by sampling error, and
...
However, \citet{Oaks2014reply} evaluated the approach proposed by
\citet{Hickerson2013} using simulations and found that it did not mitigate the
...
In the original descriptions of the \msb model \citep{Hickerson2006,Huang2011},
...
\citep[e.g.,][]{Hickerson2006,Leache2007,Stone2012}.
...
the empirical dataset of \citet{Oaks2012}, which is comprised of sequence data
...
The \empModelDPP model represents the priors that \citet{Oaks2012} would have
...
coalescent units or more (see Figure~S4 of \citet{Oaks2012}).
...
those observed by \citet{Oaks2012}, there is still an effect when comparing the
...
estimated scenarios
\citep{Barber2010,Carnaval2009,Chan2011,Hickerson2006,Leache2007,Plouviez2009,Stone2012,Voje2009,Oaks2012},
