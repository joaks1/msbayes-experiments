...
the Philippines during Pleistocene sea-level fluctuations caused
...
overparameterization and can be a great strength of the Bayesian approach.
...
\change{
As a result, the summary statistics being compared when calculating the
Euclidean distance between the observed data and each simulated dataset often
represent sequence alignments of \emph{different} taxon pairs and/or loci.
...
\change{
More generally, the simulated alignments and their summary statistics are not
identically distributed if there is any variation among taxa or loci in the
(1) numbers of sequences (\popSampleSize{1}{} and \popSampleSize{2}{}),
(2) length of alignments,
(3) numbers of loci (\nloci{}),
(4) \hky model parameters (\hkyModel{}{}),
...
and the reshuffling of the summary statistic vectors in not mathematically
valid.
...
the statistics can introduce bias.
