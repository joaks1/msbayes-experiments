...
(Figure~S\ref{figValidationAccuracyOmega}).
This results are similar for the GLM-adjusted estimates of \divTimeDispersion,
...
the all four models performing similarly when applied to the data generated
under \modelOld, the models with exponentially distributed priors performing
similarly when applied to data generated under other models, and the
\modelOld is more biased when applied to data generated under other models
...
\ref{figValidationModelChoiceOmega}).
However, both are less accurate and tends to underestimate the probability of the
