...
\response{
    Reviewer 2's comments were very helpful, and have improved the clarity of
    the manuscript. Below, in Section \ref{rev2}, I address each of Reviewer
    2's concerns along with the corresponding changes I have made in light of
    the comments.
}
...
\response{
    ...
    the statements were not made clear. Please see Section \ref{rev2} below for
    the specific edits I have made in response to this helpful comment.
}
...
\response{
    ...
    times to calculate summary statistics. I mentioned the divergence times in
