...
\newcommand{\divTimeScaled}[2]{\ensuremath{\mathcal{T_{#1\protect\ifTwoArgs{#1}{#2}{,}#2}}}\xspace}
...
\newcommand{\popSampleSize}[2]{\ensuremath{n_{#1\protect\ifTwoArgs{#1}{#2}{,}#2}}\xspace}
...
\newcommand{descendantThetaMean}[1]{\ensuremath{\hat{\descendantTheta{}{#1}}}\xspace}
