...
\begin{frame}
    ...
    %     \column{0.5\textwidth}
        \centering{
            \includegraphics<1->[width=0.7\textwidth]{../images/validation-model-choice-dpp-no-label.pdf}
        }
        % \column{0.5\textwidth}
        %     \includegraphics<2->[width=1.0\textwidth]{../images/validation-model-choice-old.pdf}
    % \end{columns}
...
\begin{frame}
    ...
    %     \column{0.5\textwidth}
        \centering{
            \includegraphics<1->[width=1.0\linewidth]{../images/validation-model-choice-dpp-violations-horizontal.pdf}
            }
        % \column{0.5\textwidth}
        %     \centering{
    ...
    \begin{uncoverenv}<2->
    \begin{itemize}
        \item The new method shows accuracy and robustness
    \end{itemize}
    \end{uncoverenv}
    \vspace{-0.5cm}
    \barefootnote{\shortfullcite{Oaks2014dpp}}
