...
\begin{frame}
    \frametitle{Causes of bias: Marginal likelihoods}
    \centerline{
    \includegraphics[width=\textwidth]{images/prior-old_prior-old_mc_behavior.pdf}}
\end{frame}
...
\begin{frame}
    ...
    \centerline{
        \includegraphics[width=0.8\textwidth]{images/prior-old_prior-old_mc_behavior.pdf}}
    \centerline{
        \includegraphics[width=0.8\textwidth]{images/prior-old_prior-dpp_mc_behavior.pdf}}
\end{frame}

\begin{frame}
    \frametitle{\dppmsbayes: Model-choice results}
    \centerline{
        \includegraphics[width=0.8\textwidth]{images/prior-dpp_prior-old_mc_behavior.pdf}}
    \centerline{
        \includegraphics[width=0.8\textwidth]{images/prior-dpp_prior-dpp_mc_behavior.pdf}}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}[c]
        \column{.5\textwidth}
            \centerline{\modelOld}
            \includegraphics[height=6.5cm]{../power-comparison/results/pymsbayes-results/plots/old_old_power_psi_mode.pdf}
        \column{.5\textwidth}
            \centerline{\modelDPP}
            \includegraphics[height=6.5cm]{../power-comparison/results/pymsbayes-results/plots/old_dpp_power_psi_mode.pdf}
    \end{columns}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}[c]
        \column{.5\textwidth}
            \centerline{\modelOld}
            \includegraphics[height=6.5cm]{../power-comparison/results/pymsbayes-results/plots/old_old_power_psi_prob.pdf}
        \column{.5\textwidth}
            \centerline{\modelDPP}
            \includegraphics[height=6.5cm]{../power-comparison/results/pymsbayes-results/plots/old_dpp_power_psi_prob.pdf}
    \end{columns}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}[c]
        \column{.5\textwidth}
            \centerline{\modelOld}
            \includegraphics[height=6.5cm]{../power-comparison/results/pymsbayes-results/plots/old_old_power_omega_median.pdf}
        \column{.5\textwidth}
            \centerline{\modelDPP}
            \includegraphics[height=6.5cm]{../power-comparison/results/pymsbayes-results/plots/old_dpp_power_omega_median.pdf}
    \end{columns}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}[c]
        \column{.33\textwidth}
            \centerline{\modelOld}
            \includegraphics[height=4.5cm]{../power-comparison/results/pymsbayes-results/plots/old_old_power_omega_median.pdf}
        \column{.33\textwidth}
            \centerline{\modelUshaped}
            \includegraphics[height=4.5cm]{../power-comparison/results/pymsbayes-results/plots/old_u-shaped_power_omega_median.pdf}
        \column{.33\textwidth}
            \centerline{\modelDPP}
            \includegraphics[height=4.5cm]{../power-comparison/results/pymsbayes-results/plots/old_dpp_power_omega_median.pdf}
    \end{columns}
\end{frame}
