...
\begin{frame}[t]
    ...
    Friends \& Family \\
    \bigskip
    \includegraphics<2->[height=2.8cm]{images/photos/mel.jpg}

    \smallskip
    \includegraphics<2->[height=2.8cm]{images/photos/coop.jpg}\hspace{1mm}
    \includegraphics<2->[height=2.8cm]{images/photos/cats.jpg}\hspace{1mm}
    \includegraphics<2->[height=2.8cm]{images/photos/luna.jpg}
    \end{center}
\end{frame}
