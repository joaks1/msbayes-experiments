...
\begin{frame}
    ...
    \begin{columns}[c]
        ...
        \column{.6\textwidth}
            ...
            \includegraphics<6-7>[height=6cm]{../images/div-model-cartoon-shared.pdf}
            \includegraphics<8>[height=6cm]{../images/div-model-cartoon-2-1.pdf}
            \includegraphics<9>[height=6cm]{../images/div-model-cartoon-2-2.pdf}
            \includegraphics<10>[height=6cm]{../images/div-model-cartoon-2-3.pdf}
            \includegraphics<11>[height=6cm]{../images/div-model-cartoon-general.pdf}
            \includegraphics<12>[height=6cm]{../images/div-model-cartoon-shared.pdf}
