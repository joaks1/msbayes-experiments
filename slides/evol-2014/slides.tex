...
\begin{frame}
    ...
    \begin{columns}[c]
        ...
        \column{.6\textwidth}
            \includegraphics<1-2>[height=6cm]{../images/community-ellipse-split-small.pdf}
            \includegraphics<3>[height=6cm]{../images/div-model-cartoon-taxa.pdf}
            \includegraphics<4>[height=6cm]{../images/div-model-cartoon-shared.pdf}
            \includegraphics<5>[height=6cm]{../images/div-model-cartoon-2-1.pdf}
            \includegraphics<6>[height=6cm]{../images/div-model-cartoon-2-2.pdf}
            \includegraphics<7>[height=6cm]{../images/div-model-cartoon-2-3.pdf}
            \includegraphics<8>[height=6cm]{../images/div-model-cartoon-general.pdf}
            % \begin{onlyenv}<7->
            %     \begin{itemize}
