...
\begin{frame}
    ...
    \begin{columns}[c]
        ...
        \begin{uncoverenv}<15->
            \begin{flushleft}
                \small We want to infer \textcolor{blue}{\divTimeMapVector}
                given DNA sequence alignments
...
%     \frametitle<2->{Population divergence model}
%     \begin{columns}[c]
%         \column{.4\textwidth}
%         \small We want to infer \textcolor{blue}{\divTimeMapVector} given DNA sequence alignments \textcolor{blue}{\alignmentVector}
%         \bigskip
%         \begin{mydescription}
%             \item<3>[\alignmentVector] Sequence alignments
%             \item<3>[\divTimeMapVector] Divergence times
%             \item<3>[\geneTreeVector] Gene trees
%             % \item<3>[\hkyModelVector] Substitution parameters
%             \item<3>[\demographicParamVector] Demographic parameters
%         \end{mydescription}
%         \column{.6\textwidth}
%         \includegraphics<1>[height=6cm]{../images/div-model-cartoon-shared.pdf}
%         \includegraphics<2->[height=6cm]{../images/div-model-cartoon-sp-tree-shared.pdf}
%     \end{columns}
% \end{frame}
