...
\begin{frame}
    \frametitle{Climate-driven diversification model: Prediction}
    \centerline{
...
\begin{frame}
    ...
    \begin{columns}[c]
        ...
        \column{.6\textwidth}
            \includegraphics<1-2>[height=6.8cm]{../images/sea-level-prediction-trees-labels-compact.pdf}
            \includegraphics<3>[height=6.8cm]{../images/sea-level-prediction-trees-labels-compact-alt1.pdf}
            \includegraphics<4->[height=6.8cm]{../images/sea-level-prediction-trees-labels-compact-alt2.pdf}
            % \begin{onlyenv}<7->
            %     \begin{itemize}
...
%     \centerline{
%         % \includegraphics<1>[width=\textwidth]{../images/sea-level-prediction-trees-labels.pdf}
%         % \includegraphics<1>[width=\textwidth]{../images/sea-level-species-trees-islands.pdf}
%         \includegraphics<1>[width=\textwidth]{../images/sea-level-species-trees-gene-trees-islands.pdf}
...
\begin{columns}[c]
    \column{.5\textwidth}
        \begin{table}%[htbp]
            ...
            % \def\fourthrowcolor{}
            % \def\fifthrowcolor{}
            \only<1>{\def\firstrowcolor{\rowcolor{rowred}}}
...
\begin{frame}
    ...
    \begin{itemize}
        \item<1-> \msb uses uniform priors on most model parameters, including
            divergence times
        \item<1-> This requires the use of broad priors
        \item<2-> Models with more divergence-time parameters have much greater
...
\begin{frame}
    ...
    \begin{center}
        \includegraphics[height=6.25cm]{../images/validation-model-choice-old.pdf}
