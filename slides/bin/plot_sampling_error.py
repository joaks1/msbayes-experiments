...
def main_cli():
    ...
    result_dir = os.path.join(project_util.REDUX_RESULT_DIR, 'sampling-error',
            'pymsbayes-results')
    ...
    sp = plotting.ScatterPlot(
            ...
            y_label = r'95% HPD $D_T$',
            ylim = (-0.05, None),
            center_text = r'Unadjusted')
    sp.center_text_size = 12.0
    sp_list.append(sp)
    ...
    pg.savefig(os.path.join(project_util.IMAGE_DIR, 'omega_over_sampling.pdf'))
