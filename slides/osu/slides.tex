...
\begin{columns}[c]
    \column{.5\textwidth}
        ...
        \centerline{
        \includegraphics<1>[height=3cm]{../../../../Dropbox/field-photos/people/rafe.jpg}
        \hspace{0.3mm}
        \includegraphics<1>[height=3cm]{../../../../Dropbox/field-photos/people/cam.jpg}}
        \centerline{
        \includegraphics<1>[height=3cm]{../../../../Dropbox/field-photos/people/charles.jpg}
        \hspace{0.3mm}
        \includegraphics<1>[height=3cm]{../../../../Dropbox/field-photos/people/jake.jpg}}
        \end{minipage}
        \end{onlyenv}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \includegraphics[width=\textwidth]{../../../../Dropbox/field-photos/gobi/mongolia-auto-shop.jpg}
    \end{columns}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}
        % \column{\dimexpr\paperwidth-10pt}
        \column{\dimexpr\paperwidth}
        \includegraphics[width=\textwidth]{../../../../Dropbox/field-photos/gobi/mongolia-teratoscincus-przewalskii-landscape.jpg}
    \end{columns}
\end{frame}
...
\begin{frame}[t]
    ...
    \only<1>{
    \begin{center}
        \includegraphics[height={3.5cm}]{../../../../Dropbox/field-photos/people/adam.png}
        \hspace{0.3mm}
        \includegraphics[height={3.5cm}]{../../../../Dropbox/field-photos/people/fujita.jpg}
    \end{center}
    }
...
\begin{frame}
    ...
    \begin{columns}
        % \column{\dimexpr\paperwidth-10pt}
        \column{\dimexpr\paperwidth}
        \includegraphics[width=\textwidth]{../../../../Dropbox/field-photos/malaysia/malaysia-burungs.jpg}
    \end{columns}
\end{frame}
