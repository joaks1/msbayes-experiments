...
def create_plots(info_path,
    ...
    pg = plotting.PlotGrid(subplots = psi_sub_plots,
            ...
            share_x = True,
            share_y = True,
            title = r'Estimated number of divergence events, $|\mathbf{\tau}|$',
            title_size = 14.0,
            title_top = False,
            y_title = 'Density',
    ...
    pg.savefig(os.path.join(output_dir, 'power-summary-psi.pdf'))
    ...
    pg.savefig(os.path.join(output_dir, 'power-summary-psi-prob.pdf'))
